...
|------------|-------------|
| `backend/` | Node.js, Express, TypeScript, PostgreSQL (Prisma). ERP/CRM/WMS API, JWT auth. See [backend/README.md](backend/README.md). |
...
PM2 + Nginx on Ubuntu EC2. GitHub Actions redeploys on push to `master` / `main`.

**Guide:** [DEPLOYMENT.md](DEPLOYMENT.md)

**Repo:** [github.com/botirov206/kiyim_chechak_fullstack](https://github.com/botirov206/kiyim_chechak_fullstack)
