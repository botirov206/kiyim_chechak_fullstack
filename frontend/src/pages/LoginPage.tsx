        ...
        <div className="w-full sm:max-w-md">
          ...
          <Card className="p-6">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={!canSubmit} leftIcon={isLoading ? <Spinner size={18} /> : null}>
          ...
          <div className="mt-4 text-xs text-white/50">
            Tip: Ensure your API URL is set via <span className="font-semibold">VITE_API_URL</span>.
          </div>
